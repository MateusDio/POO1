...
public class TelaNotas extends javax.swing.JFrame {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtn2, javax.swing.GroupLayout.DEFAULT_SIZE, 272, Short.MAX_VALUE)))
                    .addGroup(layout.createSequentialGroup()
                        .addGap(207, 207, 207)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        Aluno a = new Aluno(txtNome.getText(), Double.parseDouble(txtn1.getText())
                , Double.parseDouble(txtn2.getText()));
        GerenciadorDeNotas g = new GerenciadorDeNotas();
       labelResul.setText(g.verificarSituação(a.calcuMedia()));
        System.out.println(a.toString());
        
        System.out.println(g.verificarSituação(a.calcuMedia()));
